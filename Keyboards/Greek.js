...
function call(event) {
    var mappings = [["a", "α"], ["b", "β"], ["c", "ψ"], ["d", "δ"], ["e", "ε"], ["f", "φ"], ["g", "γ"], ["h", "η"], ["i", "ι"], ["j", "ξ"], ["k", "κ"], ["l", "λ"],
    ["m", "μ"], ["n", "ν"], ["o", "ο"], ["p", "π"], ["q", ""], ["r", "ρ"], ["s", "σ"], ["t", "τ"], ["u", "θ"], ["v", "ω"], ["w", "ς"], ["x", "χ"], ["y", "υ"], ["z", "ζ"],
    [".α", "ά"], [".ε", "έ"], [".η", "ή"], [".ι", "ί"], ["-ι", "ϊ"], ["=ι", "ΐ"], [".ο", "ό"], [".υ", "ύ"], ["-.υ", "ϋ"], ["=υ", "ΰ"], [".ω", "ώ"],
    [".Α", "Ά"], [".Ε", "Έ"], [".Η", "Ή"], [".Ι", "Ί"], ["-Ι", "Ϊ"], ["=Ι", "Ϊ́ϊ"], [".Ο", "Ό"], [".Υ", "Ύ"], ["-.υ", "Ϋ"], ["=υ", "Ϋ́"], [".Ω", "Ώ"]
    ];
...
async function splfunc(event) {
    ...
    if (e.target.innerText === "Google Translate") {
        window.open(`https://translate.google.com/?sl=el&tl=en&text=${google}&op=translate`, '_blank');
    }
    if (e.target.innerText === "Dictionary") {
        window.open(`https://greek-dictionary.org/search?search=${google}&searchtype=greek`, '_blank');
    }
    ...
    if (e.target.innerText === "Spell Check") {
        await tocopy();
        window.open(`https://textgears.com/greek-grammar-check`, '_blank');
    }
