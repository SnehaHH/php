...
function call(event) {
    var mappings = [["+a", "á"], ["+e", "é"], ["+A", "Á"], ["+E", "É"], ["+i", "í"], ["+I", "Í"], ["+n", "ñ"], ["+N", "Ñ"], ["+o", "ó"], ["+O", "Ó"], ["+u", "ú"],
    ["+U", "Ú"], [".u", "ü"], [".U", "Ü"]];
...
for (i = 0; i < allFieldSetElements.length; i++) {
    if (allFieldSetElements[i].tagName === "BUTTON" &&
        ...
        allFieldSetElements[i].innerText == "á" || allFieldSetElements[i].innerText == "é" || allFieldSetElements[i].innerText == "í" || 
        allFieldSetElements[i].innerText == "ñ" || allFieldSetElements[i].innerText == "ó" || allFieldSetElements[i].innerText == "ú" || 
        allFieldSetElements[i].innerText == "ü")
...
async function splfunc(event) {
    ...
    if (e.target.innerText === "Google Translate") {
        window.open(`https://translate.google.com/?sl=es&tl=en&text=${google}&op=translate`, '_blank');
    }
    if (e.target.innerText === "Dictionary") {
        window.open(`https://dictionary.reverso.net/spanish-english/${google}`, '_blank');
    }
    ...
    if (e.target.innerText === "Spell Check") {
        await tocopy();
        window.open(`https://spanishchecker.com/en/`, '_blank');
    }
