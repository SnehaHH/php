...
<body>
        ...
        <div class="sales-boxes">
            <div class="recent-sales box">
                ...
                <ul class="details">  
                    ...
                    ?>  
                    <div class="card" style="width: 18rem;" id="tovids">
                        <img class="card-img-top" src="../images/flag.png" alt="Card image cap">
                        <div class="card-body">
    ...
    <script>
        ...
        document.getElementById("tovids").addEventListener("onclick",imlost);
    </script>
