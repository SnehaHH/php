                        ...
                        if (isset($_POST["submit"])) {
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    ?>
                                    <form method="post" action="delete_student.php">
                                        <div class="form-group"><label> User ID </label> <input class="form-control" type="text" name="ID"
                                                                        value="<?php echo $id; ?> " readonly/></div>
                                        <div class="form-group"><label> Name </label> <input class="form-control" type="text" name="name"
                                                                                             value="<?php echo $name; ?> " readonly/> </div>
                                            <div class="form-group"><label> Email </label> <input class="form-control" type="email" name="email"
                                                                                                  value=" <?php echo $email; ?> " readonly/> </div>
